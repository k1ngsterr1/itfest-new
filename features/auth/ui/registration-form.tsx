...
import { Form, FormControl, FormField, FormItem, FormLabel, FormMessage } from '@/shared/shadcn/components/ui/form'

const formSchema = z.object({
    companyName: z.string().min(2, 'Company name must be at least 2 characters'),
    password: z.string().min(8, 'Password must be at least 8 characters'),
    employeeCount: z.number().int().positive('Employee count must be a positive number'),
